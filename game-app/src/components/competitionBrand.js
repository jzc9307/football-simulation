...
const brands={
  ...
  // Keep the top-flight branding entirely separate from the 2. Bundesliga
  // asset.  The horizontal Bundesliga lock-up is more legible than trying to
  // crop the second-tier badge into a square.
