...
export function playLeagueRound(s){
      ...
      next=recordScheduledResult(next,{competition:leagueCompetition(s.league,s.division),homeId:userResult.isHome?s.myClubId:userResult.opponentId,awayId:userResult.isHome?userResult.opponentId:s.myClubId,myGoals:userResult.isHome?userResult.myGoals:userResult.oppGoals,oppGoals:userResult.isHome?userResult.oppGoals:userResult.myGoals,round:gw});
...
export function playEuropeanLeague(s,competition="UCL"){
      ...
      const { updates, userResult, performanceUpdates, fixtures } = simulateUclRound({...s,ucl:u}, u.clubs, round);
