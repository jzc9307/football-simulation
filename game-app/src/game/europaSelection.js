...
const FIRST_SEASON_DOMESTIC_IDS=["afc","cry","sun","oly","oly2","sta2","bay","tsg","acm","juv","rcc","rso","pt-benfica"];
const FIRST_SEASON_GUEST_IDS=["ararat","sal","sturm","ander","usg","levski","din","omonoia","sparta","plzen","ofi","oly","ferenc","hapoel","az","nec","lillestrom","jagiell","lech","torreense","cel","celje","besiktas"];
